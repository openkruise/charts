# Agents Sandbox Controller v0.6.0-alpha2
...
| `image.tag`                  | sandbox-controller image tag              | `v0.6.0-alpha2`                                                                                                         |
...
| `agentRuntime.image.tag` | Injected agent-runtime sidecar image tag | `v0.6.0-alpha2` |
...
| `commitJob.image.tag` | Image tag of the Commit job pods | `v0.6.0-alpha2` |
...
- A native sidecar container named `agent-runtime`, built from
  ...
  `openkruise/agent-runtime:v0.6.0-alpha2`. The sidecar carries its own `ENVD_DIR`
