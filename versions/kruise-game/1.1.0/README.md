...
| `image.repository`                         | Repository for kruise-game image                                            | `ghcr.io/ballista01/kruise-game-manager` |
| `image.tag`                                | Tag for kruise-game image                                                   | `dev`                            |
| `image.digest`                             | Optional image digest to pin a build (overrides tag when set)               | ``                               |
